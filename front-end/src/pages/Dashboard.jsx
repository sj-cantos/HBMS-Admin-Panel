...
const Dashboard = () => {
  ...
  useEffect(() => {
    const getWidgetData = () => {
      axios
        .get("http://localhost:3003/dashboard/widget")
        .then((response) => {
  ...
  useEffect(() => {
    const getRecentBookings = () => {
      axios
        .get("http://localhost:3003/dashboard/recent-bookings")
        .then((response) => {
        ...
        >
          <Flex alignItems="center">
            <Box ml="10px" alignItems="center">
              <Heading fontWeight="semibold" fontSize="18px" color="gray.500">
                {" "}
                Bookings
              </Heading>
              <Text mt="5px" fontSize="25px" fontWeight="semibold">
                {widgetData.totalBookings}
              </Text>
            </Box>
            <Icon
              as={AiFillBook}
